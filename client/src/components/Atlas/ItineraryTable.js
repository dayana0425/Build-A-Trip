            ...
            <Col>
                <Row>
                    ...
                    <Tooltip title="Save Trip">
                        <Button style={buttonStyles} color="primary" onClick={() => {
                            this.refs.file.saveFile(JSON.stringify(this.refs.file.saveFileFormat()), this.state.tripName, 'application/json')
                        }}>
                            <Save> </Save>
                        </Button>
                    </Tooltip>
